        ...
        <div class="col-lg-12">
            <h1 class="page-header">
                ...
                <span class="pull-right">
                    <a href="/manage/messages/create?movie_id={{$movie_id}}" class="btn btn-success"><i
                                class="fa fa-plus"></i> 添加剧组通知</a>
                </span>
            </h1>
        </div><!-- /.col-lg-12 -->
    </div><!-- /.row -->
                ...
                <div class="panel-body">
                    <table id="dataTablesOne"
                        ...
                        @foreach($messages as $message)
                            <tr>
                                <td><a href="/manage/messages/{{$message->id}}">{{$message->title}}</a></td>
                                <td class="center">
                                    <a href="/manage/messages/{{$message->id}}/receivers?movie_id={{$movie_id}}">{{$message->readRate()}}</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    @else
                                        <button url="/manage/messages/{{$message->id}}/redo?type=JUZU
