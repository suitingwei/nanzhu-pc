                    ...
                    <form id="submitForm" action="/manage/messages" class="form-horizontal form-row-seperated"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea id="content" class="form-control" rows="8" placeholder="输入剧组通知内容"
                                ...
                                <div class="col-md-8">
                                    <div id="dropzPic" class="dropzone">
                                        <div class="dz-message">
                                            将文件拖至此处或点击上传.<br/>
                                            <span class="help-block"> 上传格式 {{ implode(',',$allowedUploadFileTypes) }}<span class="h4 text-danger">主文件名中不能带 "."</span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $("#dropzPic").dropzone({
            ...
            init: function () {
                this.on("addedfile", function (file) {
                    ...
                    var suffixNames = ["xls", "xlsx", "pdf", "png", "jpg", "doc", "docx",'ppt','pptx','jpeg'];
                    if (jQuery.inArray(suffixName, suffixNames) < 0) {
                        alert('请选择文件格式为： doc,docx,xls,xlsx,pdf,png,jpg,ppt,pptx,jpeg 的文件上传');
                        this.removeFile(file);
                    }
                ...
                this.on('success', function (file, response) {
                    ...
                    if (response.data.is_image_type) {
                        ...
                        newImgInput = "<input type=hidden name='file_url[]' value='" + response.data.uploaded_file_url +"'"+
